...
Full-stack Software Engineer with experience designing and delivering production systems end to end. Energized by new challenges, whether that means diving into unfamiliar codebases, scaling infrastructure, or collaborating across teams to ship meaningful products.
...
I've worked across defense systems, e-commerce platforms, and full-stack web apps. Some highlights - optimizing databases to significantly cut load times, building React interfaces that actually move the needle on conversions, and setting up CI/CD pipelines that took deployments from hours down to minutes.

How I Work

I care about writing code that's easy to come back to six months later. I lean toward shipping early, testing thoroughly, and keeping things secure. I learn best by building, and I like teams where people teach each other.
